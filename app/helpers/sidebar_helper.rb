...
module SidebarHelper
  def active_class(link_path)
    ...
    if link_path == '/guests' && (request.path == '/' || request.path == "/#{I18n.locale}")
      ...
      return 'text-customPink bg-customPink bg-opacity-20 font-semibold border-l-8 border-customPink transition duration-200 text-xl'
    end
    ...
    'text-black hover:text-customPink font-semibold border-l-8 border-transparent transition duration-200 text-xl'
  end
end
