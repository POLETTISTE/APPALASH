...
class PrestationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create prestation' do
    assert_difference('Prestation.count') do
      post prestations_url, params: { prestation: { name: @prestation.name, price: @prestation.price } }
    end
  ...
  test 'should update prestation' do
    patch prestation_url(@prestation), params: { prestation: { name: @prestation.name, price: @prestation.price } }
